describe ResourcePoolCloudController do
  ...
  describe "#button" do
    ...
    context 'Check Compliance action on VMs of a Resource Pool' do
      ...
      before do
        ...
        controller.params = {:miq_grid_checks => vm.id.to_s, :pressed => 'vm_check_compliance', :id => resource_pool.id.to_s, :controller => 'resource_pool_cloud'}
      end
    ...
    context 'deleting Resource Pool' do
      before do
        ...
        controller.params = {:pressed => 'resource_pool_cloud_delete'}
      end

      it 'calls deletecloudresourcepools and replace_gtl_main_div' do
        expect(controller).to receive(:deletecloudresourcepools)
      ...
      context 'default div to refresh' do
        before do
          allow(controller).to receive(:deletecloudresourcepools)
      ...
      context 'nested list of Resource Pools' do
        ...
        it 'calls deletecloudresourcepools and render_flash' do
          expect(controller).to receive(:deletecloudresourcepools)
    ...
    context 'managing policies of Resource Pools' do
      before do
        controller.instance_variable_set(:@display, nil)
        controller.params = {:pressed => 'resource_pool_cloud_protect'}
      end
    ...
    context 'tagging Resource Pool' do
      before do
        controller.instance_variable_set(:@display, nil)
        controller.params = {:pressed => 'resource_pool_cloud_tag'}
      end

      it 'calls tag method' do
        expect(controller).to receive(:tag).with(ManageIQ::Providers::CloudManager::ResourcePool)
        controller.send(:button)
      end
    end
  end
