  ...
  describe "Instance Workflows" do
    ...
    describe "#instance_update" do
      ...
      it "handles database errors gracefully" do
        ...
        allow(MiqAeInstance).to receive(:find).and_call_original
        allow(MiqAeInstance).to receive(:find).with(@ae_instance.id.to_s).and_return(@ae_instance)
        allow(MiqAeInstance).to receive(:find).with(@ae_instance.id).and_return(@ae_instance)
