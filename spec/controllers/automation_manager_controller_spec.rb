describe AutomationManagerController do
  ...
  let(:automation_provider1) { FactoryBot.create(:provider_ansible_tower, :name => "ansibletest") }
  let(:automation_provider2) { FactoryBot.create(:provider_ansible_tower, :name => "ansibletest2") }
  let(:automation_provider3) { FactoryBot.create(:provider_ansible_tower, :name => "ansibletest_no_cs") }
