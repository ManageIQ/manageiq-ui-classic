...
describe ApplicationHelper::Button::ZoneDelete do
  ...
  describe '#calculate_properties' do
    ...
    context 'when selected zone is the default one' do
      ...
      include_examples 'ApplicationHelper::Button::Basic disabled', :error_message => "'Default' zone cannot be deleted"
    end
    ...
    context 'when selected zone is not the default one' do
      context 'and zone has ext_management_systems' do
        ...
        include_examples 'ApplicationHelper::Button::Basic disabled', :error_message => 'Cannot delete a Zone that has Relationships'
      end
      ...
      context 'and zone has miq_schedules' do
        ...
        include_examples 'ApplicationHelper::Button::Basic disabled',
                         :error_message => 'Cannot delete a Zone that has Relationships'
      end
