...
describe('Automate > Customization > Service Dialogs > Add Dialog > TextArea Tests', () => {
  beforeEach(() => {
    cy.navigateToAddDialog();
    cy.dragAndDropComponent('Text Area');
  });

  it('should verify default properties of the textarea', () => {
    // Verify the textarea exists
    cy.get('.dynamic-form-field')
      .should('exist');
    // Verify the textarea has default label "Text Area"
    cy.get('.dynamic-form-field .bx--label')
      .should('contain', 'Text Area');
    // Verify the textarea is not read-only by default
    cy.get('.dynamic-form-field .bx--text-area')
  ...
  it('should open the modal when clicking the edit button', () => {
    ...
    cy.get('.edit-field-modal .bx--modal-header__heading')
      .should('contain', 'Edit this Text Area');
  ...
  // Test to verify textarea properties with dynamic off
  it('should apply and reflect properties with dynamic off', () => {
    ...
    // Verify the textarea reflects the changes
    cy.get('.dynamic-form-field .bx--label')
