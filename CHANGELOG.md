...
- Policy edit: fix double flash. [(#2406)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2406)
- Update openstack validation parameters [(#2394)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2394)
- Middleware jdbc driver enhancements [(#2376)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2376)
- Display flash messages in Advanced search [(#2374)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2374)
- Show subnets dropdown for SCVMM provisioning [(#2373)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2373)
- Adding section for Physical Servers in default filters configuration screen [(#2338)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2338)
- My Services: correctly render flash array [(#2329)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2329)
- Show 'no data' under container dashboard alerts  [(#2289)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2289)
- Only display VmOrTemplate as choice for relationships that belong to the same provider [(#2271)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2271)
- Validate infra providers on the queue [(#2243)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2243)
- Container summary screen: Check if role_allows? Environment Variables [(#2110)](https://github.com/ManageIQ/manageiq-ui-classic/pull/2110)
