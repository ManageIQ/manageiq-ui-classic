    ...
    class << self
      ...
      def catalogs_menu_section
        Menu::Section.new(:catalog, N_("Catalogs"), nil, [
          Menu::Item.new('catalog_service_template_catalog',        N_('All Catalogs'),         'catalog_service_template_catalogs',         {:feature => 'catalog_service_template_catalogs_show_list'}, '/service_template_catalog/show_list'),
