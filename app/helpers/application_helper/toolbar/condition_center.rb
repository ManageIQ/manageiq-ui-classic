    ...
    select(
      ...
      :items => [
        ...
        button(
          ...
          t = proc do
            _('Delete this %{condition_type} Condition') % {:condition_type => ui_lookup(:model => @condition.resource_type)}
          end,
          t,
          :url_parms    => "main_div",
          :send_checked => true,
          :klass        => ApplicationHelper::Button::Condition,
          :confirm      => proc { _("Are you sure you want to delete this %{condition_type} Condition?") % {:condition_type => ui_lookup(:model => @condition.resource_type)} }),
        button(
          :condition_remove,
          'pficon pficon-delete fa-lg',
          t = proc do
