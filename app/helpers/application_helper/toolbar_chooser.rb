class ApplicationHelper::ToolbarChooser
  ...
  def view_toolbar_filename
    ...
    elsif !%w[all_tasks condition miq_alert miq_alert_set timeline diagnostics miq_policy my_tasks miq_server usage].include?(@layout) &&
  ...
  def center_toolbar_filename_explorer
    ...
    elsif %w[miq_action miq_alert_set miq_event].include?(@layout)
