class ApplicationHelper::ToolbarChooser
  ...
  def view_toolbar_filename
    ...
    elsif !%w[all_tasks condition timeline diagnostics miq_action miq_alert miq_alert_set miq_event_definition miq_policy miq_policy_set my_tasks miq_server usage services].include?(@layout) &&
