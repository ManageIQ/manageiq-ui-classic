import miqComponent from './index';
...
describe('Component API', () => {
  ...
  it('ManageIQ.component namespace is defined', () => {
    expect(ManageIQ.component).toBeDefined();
    expect(ManageIQ.component.define).toEqual(expect.any(Function));
    expect(ManageIQ.component.newInstance).toEqual(expect.any(Function));
    expect(ManageIQ.component.getInstance).toEqual(expect.any(Function));
    expect(ManageIQ.component.isDefined).toEqual(expect.any(Function));
  });
