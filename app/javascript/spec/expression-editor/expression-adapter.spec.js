...
describe('round-trip miqToRqb → rqbToMiq', () => {
  const cases = [
    ...
    ['specific date value', { IS: { field: 'Vm-retires_on', value: '12/25/2024' } }],
    ['relative date value', { BEFORE: { field: 'Vm-retires_on', value: 'Today' } }],
    ['FROM atom with array values', { FROM: { field: 'Vm-retires_on', value: ['Today', 'Last Week'] } }],
    [':user_input sentinel', { '=': { field: 'Vm-name', value: ':user_input' } }],
  ];
