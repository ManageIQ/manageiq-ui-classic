...
const TESTCASES = [
  [ // Example Case
    'selectedUser=all&approvalStateCheckboxes=pending_approval&approvalStateCheckboxes=approved'
      + '&approvalStateCheckboxes=denied&types=all&selectedPeriod=7&reasonText=',
    'selectedUser=all&approvalStateCheckboxes[]=pending_approval&approvalStateCheckboxes[]=approved'
      + '&approvalStateCheckboxes[]=denied&types=all&selectedPeriod=7&reasonText=',
  ], [
    'foo=bar',
