...
describe('ReconfigureTable', () => {
  it('should render disk table with headers and rows', () => {
    const wrapper = shallow(<ReconfigureTable headers={diskHeaders} rows={diskRows} />);
  ...
  it('should render network table with headers and rows', () => {
    const wrapper = shallow(<ReconfigureTable headers={networkHeaders} rows={networkRows} />);
    expect(wrapper.find('MiqDataTable')).toHaveLength(1);
  ...
  it('should render drive table with headers and rows', () => {
    const wrapper = shallow(<ReconfigureTable headers={driveHeaders} rows={driveRows} />);
    expect(wrapper.find('MiqDataTable')).toHaveLength(1);
  ...
  it('should call onCellClick when a cell is clicked', () => {
    ...
    const wrapper = shallow(<ReconfigureTable headers={diskHeaders} rows={diskRows} onCellClick={onCellClick} />);
