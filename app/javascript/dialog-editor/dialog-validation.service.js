...
export class DialogValidationService {
  ...
  dialogIsValid(dialogData) {
    ...
    return _.every(dialogData, (dialog) =>
      validateDialog(dialog) && _.every(dialog.dialog_tabs, (tab) =>
        validateTab(tab) && _.every(tab.dialog_groups, (group) =>
          validateGroup(group) && _.every(group.dialog_fields, (field) =>
            validateField(field)))));
  }
}
