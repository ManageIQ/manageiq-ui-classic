      ...
      <div class="card-pf card-pf-view">
        <div class="card-pf-body">
          <div class="card-pf-heading-kebab">
            <dropdown-menu widget-id="{{vm.widgetId}}" buttons-data="{{vm.widgetButtons}}"></dropdown-menu>
    ...
    {{vm.widgetTitle}}
        ...
        <div ng-if="vm.widgetBlank === 'true' || vm.widgetModel" ng-attr-id="{{vm.innerDivId}}" ng-class="{ hidden: vm.widgetModel.minimized, mc:true }">
          ...
          <div ng-if="vm.widgetBlank === 'false'" ng-switch on="vm.widgetType">
            <widget-menu ng-switch-when="menu" widget-id="{{vm.widgetId}}" widget-model="vm.widgetModel"></widget-menu>
            <widget-report ng-switch-when="report" widget-id="{{vm.widgetId}}" widget-model="vm.widgetModel"></widget-report>
            <widget-chart ng-switch-when="chart" widget-id="{{vm.widgetId}}" widget-model="vm.widgetModel"></widget-chart>
            <widget-rss ng-switch-when="rss" widget-id="{{vm.widgetId}}" widget-model="vm.widgetModel"></widget-rss>
          </div>
