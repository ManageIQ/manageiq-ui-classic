...
const InstanceForm = ({ recordId, classId }) => {
  ...
  return (
    <div className="dialog-provision-form">
      <form onSubmit={onSubmit}>
        <h3>{__('Main Info')}</h3>
        <div className="form-horizontal" style={{ marginBottom: '20px' }}>
        ...
        <div className="custom-button-wrapper" style={{ marginTop: '20px' }}>
          <Button
      ...
      <Modal
        ref={modalRef}
        open={isModalOpen}
        modalHeading={selectedField ? `Edit ${selectedField.display_name || selectedField.name}` : 'Edit Field'}
