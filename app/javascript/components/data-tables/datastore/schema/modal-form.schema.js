  ...
  return {
    fields: [
      ...
      },
      {
        ...
        includeEmpty: !getType(aeTypeOptions, getIcons(0)),
      ...
      },
      {
        ...
        includeEmpty: !getType(dTypeOptions, getIcons(1)),
        initialValue: getType(dTypeOptions, getIcons(1)),
        clearFields: ['default_value'],
      },
      {
        component: componentTypes.TEXT_FIELD,
        name: 'default_value',
        ...
        resolveProps: (_props, _field, { getState }) => ({
          type: getState().values.datatype === 'password' ? 'password' : 'text',
        }),
      },
      {
        component: componentTypes.TEXT_FIELD,
