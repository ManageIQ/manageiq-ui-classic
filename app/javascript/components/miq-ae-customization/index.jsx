...
const MiqAeCustomization = ({ dialogRecord, dialogTypes }) => {
  ...
  const onSubmit = (values) => {
    ...
    request
      .then(() => {
        const confirmation = isEdit ? __('Dialog Edited') : __('Dialog Created');
  ...
  const onCancel = () => {
    const confirmation = dialogRecord.id ? __('Editing dialog cancelled by the user') : __('Creating new dialog cancelled by the user');
