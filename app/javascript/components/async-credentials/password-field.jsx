    ...
    <>
      ...
      {edit && !editMode && (
        <FormGroup legendText={rest.label}>
          <Grid condensed className="miq-password-field-grid">
            <Column sm={3} md={7} lg={15} className="miq-password-field-grid-column">
              <TextInput
                labelText=""
            ...
            <Column sm={1} md={1} lg={1} className="miq-password-field-edit-icon-grid-column">
              <Button
                hasIconOnly
                kind="primary"
                size="md"
