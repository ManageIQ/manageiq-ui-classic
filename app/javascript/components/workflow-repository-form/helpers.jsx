...
// sshProtocolRegex matches SSH URLs with ssh:// protocol (supports both / and : as path separator, path is optional)
// Examples: ssh://github.com/, ssh://github.com/user/repo.git, or ssh://github.com:user/repo.git
