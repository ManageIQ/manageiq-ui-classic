...
const AutomateSimulationForm = ({
  resolve, maxNameLength, url, aeAnsibleCustomButton, formAction, aeCustomButton, attrValuesPairs, maxLength,
}) => {
    ...
    <div className="automate-simulation-page">
      <div className="automate-simulation-form-wrapper">
        <MiqFormRenderer
          ...
          schema={createSchema(
            resolve, maxNameLength, url, aeAnsibleCustomButton, formAction, aeCustomButton, attrValuesPairs,
...
AutomateSimulationForm.propTypes = {
  ...
  aeAnsibleCustomButton: PropTypes.bool.isRequired,
