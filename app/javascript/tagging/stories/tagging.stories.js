...
const tags = [
  ...
  {
    description: 'Number xxx xxxxxxxxxxxx xxx xxxxxxxxx xxx',
    id: 2,
    singleValue: true,
    values: [{
      description: '1',
  ...
  {
    description: 'Food xxx xxxxxxxxxxxx xxx xxxxxxxxx xxx',
    id: 4,
    singleValue: true,
    values: [{
      description: 'Steak',
...
storiesOf('Tagging', module)
  .add('Tagging with hidden reset button', () =>
    (
      <Provider store={store}>
        <TaggingWithButtonsConnected
          showReset={false}
