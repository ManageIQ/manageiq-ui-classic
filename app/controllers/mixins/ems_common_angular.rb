  ...
  module EmsCommonAngular
    ...
    def ems_form_fields
      ...
      return_fields = {:name                      => @ems.name,
                       ...
                       :has_events_tab            => @ems.supports_configure_events?}
      cloud_network_infra_container_fields = {:api_version     => @ems.api_version || "v2",
                                              :provider_region => @ems.provider_region}
      cloud_network_infra_fields = {:provider_id            => @ems.provider_id || "",
      ...
      infra_container_fields = {:kubevirt_api_port          => kubevirt_api_port,
      ...
      if controller_name == "ems_cloud" || controller_name == "ems_network"
        render :json => return_fields.merge(cloud_network_infra_container_fields).merge(cloud_network_infra_fields).merge(
      ...
      if controller_name == "ems_infra"
        render :json => return_fields.merge(cloud_network_infra_container_fields).merge(cloud_network_infra_fields).merge(infra_container_fields).merge(
          :default_api_port              => default_api_port || "",
      ...
      if controller_name == "ems_container"
        render :json => return_fields.merge(cloud_network_infra_container_fields).merge(infra_container_fields).merge(
          :hostname                            => @ems.hostname,
          :default_api_port                    => @ems.connection_configurations.default.endpoint.port,
          :service_account                     => service_account.to_s,
      ...
      if controller_name == "ems_middleware"
        render :json => return_fields.merge(
          :default_hostname     => @ems.connection_configurations.default.endpoint.hostname,
          :default_api_port     => @ems.connection_configurations.default.endpoint.port,
          :default_tls_ca_certs => default_tls_ca_certs
        )
