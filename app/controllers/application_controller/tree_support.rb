module ApplicationController::TreeSupport
  ...
  def find_record
    ...
    if %w(host container_replicator container_group container_node container_image ext_management_system physical_server middleware_server).include? controller_name
