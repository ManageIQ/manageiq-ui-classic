  ...
  def replace_right_cell(options = {})
    ...
    if @pages || @in_a_form
      if @pages && !@in_a_form
        ...
        elsif %w[detach ownership add_security_group remove_security_group].include?(@sb[:action])
      ...
      if %w[associate_floating_ip attach disassociate_floating_ip evacuate live_migrate resize].include?(@sb[:action])
