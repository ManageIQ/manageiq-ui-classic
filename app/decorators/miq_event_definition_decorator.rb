class MiqEventDefinitionDecorator < MiqDecorator
  def fonticon
    convert = {
      ...
      "eap_app_deploy"                              => "pficon pficon-middleware",
      "eap_app_undeploy"                            => "pficon pficon-middleware",
      "eap_datasource_create"                       => "pficon pficon-middleware",
      "eap_datasource_delete"                       => "pficon pficon-middleware",
      ...
      "jdbc_driver_deploy"                          => "pficon pficon-middleware",
      "jdbc_driver_undeploy"                        => "pficon pficon-middleware",
