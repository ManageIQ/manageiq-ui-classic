ManageIQ.angular.app.controller('cloudNetworkFormController', ['cloudNetworkFormId', 'networkProviderChoices', 'miqService', 'API', function(cloudNetworkFormId, networkProviderChoices, miqService, API) {
  var vm = this;
