angular.module('miq.util').factory('metricsHttpFactory', function() {
  return function (dash, $http, utils, miqService) {
    ...
    var getTenants = function() {
      var url = '/container_dashboard/data' + dash.providerId  + '/?live=' + dash.db + '&query=get_tenants';
      ...
      return $http.get(url).then(function(response) {
        ...
        // update the dash url
        dash.url = '/container_dashboard/data' + dash.providerId  + '/?live=' + dash.db + '&tenant=' + dash.tenant.value;
      });
    }
