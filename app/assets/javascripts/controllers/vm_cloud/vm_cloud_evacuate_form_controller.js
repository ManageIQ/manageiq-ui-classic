ManageIQ.angular.app.controller('vmCloudEvacuateFormController', ['$http', 'vm', 'vmCloudEvacuateFormId', 'miqService', function($http, vm, vmCloudEvacuateFormId, miqService) {
  vm.vmCloudModel = {
