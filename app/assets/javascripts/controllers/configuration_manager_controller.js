ManageIQ.angular.app.controller('configurationManagerController', ['$http', '$scope', 'configurationManagerFormId', 'miqService', 'configurationManagerService', 'modelName', 'url', function($http, $scope, configurationManagerFormId, miqService, configurationManagerService, modelName, url) {
  var vm = this;
