...
securityGroupFormController.$inject = ['miqService', 'API', '$q'];

function securityGroupFormController(miqService, API, $q) {
    var vm = this;
    ...
    var init = function() {
        ...
        vm.networkProviderChoices = vm.networkProviderChoices;
